    ...
    <div class="checkout">
                ...
                <div class="table-responsive" id="order_table">
                    <table class="table table-bordered table-striped">
                        ...
                        <tr>
                            ...
                            <td align="right">
                                <?php echo $_SESSION['currency']['logo'] . " " . $values["product_price"] ?>
                            </td>
                            <td align="right"> <b>
                                    <?php echo $_SESSION['currency']['logo'] . " " . $values["product_total"] ?>
                                </b></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td align="right"><b>
                                    <?php echo $_SESSION['currency']['logo'] . " " . $_SESSION['shipping'] ?>
                                </b></td>
                        </tr>

                        <tr>
                            <td colspan="2" align="right"><b>Total</b></td>
                            <td align="right" style="color:red;"><b>
                                    <?php echo $_SESSION['currency']['logo'] . " " . $_SESSION['shopping_cart_total'] ?>
                                </b></td>
                        </tr>
                    </table>
                </div>
        ...
        <div class="container2">
            ...
            <div class="payment_details">
                ...
                <h4>Your personal data will be used to process your order and support your experience throughout this
                    website.</h4>
