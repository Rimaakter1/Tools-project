		...
		<div id="content">
			...
			<div class="main-content">
						...
						<div class="card card-stats">
							<div class="card-header">
								<div class="icon icon-success">
									<span class="material-icons">BDT</span>
				...
				<div class="delivery_infos">
					...
					<label class="col-sm-3 col-md-4 control-label">Delivery cost: <span id="cost">
									...
									<tbody>
										...
										<tr>
											...
											<td id="to_<?php echo $row['currency_id'] ?>">
												<?php echo $row['to_currency']; ?>
											</td>
											<td id="price_<?php echo $row['currency_id'] ?>">
												<?php echo $row['convert_price']; ?>
											</td>
													...
													<div class="panel-body">
														<form action="" method="post">
															...
															<div class="form-group">
																<label class="col-sm-3 col-md-4 control-label">Delivery
																	Cost</label>
																<div class="col-sm-8">
												...
												<div class="panel panel-default">
													<div class="panel-body">
														<form action="" method="post">
															...
															<div class="form-group">
																<label
																	class="col-sm-3 col-md-4 control-label">convert</label>
																<div class="col-sm-8">
												...
												<div class="panel panel-default">
													<div class="panel-body">
														<form action="" method="post">
															...
															<div class="form-group">
																<label class="col-sm-3 col-md-4 control-label">to
																	currency</label>
																<div class="col-sm-8">
