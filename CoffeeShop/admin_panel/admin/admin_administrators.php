					...
					<div class="tabbed_area">
						...
						<ul class="tabs">
							<li><a href="javascript:tabSwitch('tab_1', 'content_1');" id="tab_1" class="active">View
									Administrators</a></li>
							<li><a href="javascript:tabSwitch('tab_2', 'content_2');" id="tab_2">Add Administrator</a>
							</li>
						</ul>
								...
								<table width="220" height="106" border="0">
									...
									<tr>
										<td align="center"><input name="name" type="text" style="width:100%"
												placeholder="Admin Name" required="required" id="add_admin_name" /></td>
									</tr>
									<tr>
										<td align="center"><input name="phone" type="text" style="width:100%"
												placeholder="Phone Number" required="required" id="add_admin_phone" />
										</td>
									</tr>
									<tr>
										<td align="center"><input name="email" type="email" style="width:100%"
												placeholder="Email" required="required" id="add_admin_email" /></td>
									</tr>
									<tr>
										<td align="center"><input name="username" type="text" style="width:100%"
												placeholder="Username" required="required" id="add_admin_username" />
										</td>
									</tr>
									<tr>
										<td align="center"><input name="password" type="text" style="width:100%"
												placeholder="Password" required="required" id="add_admin_password" />
										</td>
									</tr>
									<tr>
												...
												<div class="panel panel-default">
													<div class="panel-body">
														<form action="" method="post" enctype="multipart/form-data">
															...
															<div class="form-group">
																<label class="col-sm-3 col-md-4 control-label">Admin
																	Name</label>
																<div class="col-sm-8">
