								...
								<table width="220" height="106" border="0">
									...
									<tr>
										<td align="center"><input name="name" type="text" style="width:100%"
												placeholder="Member Name" required="required" id="add_member_name" />
										</td>
									</tr>
									<tr>
										<td align="center"><input name="role" type="text" style="width:100%"
												placeholder="Role" required="required" id="add_member_role" /></td>
									</tr>
									<tr>
										<td align="center"><input name="phone" type="text" style="width:100%"
												placeholder="Phone Number" required="required" id="add_member_phone" />
										</td>
									</tr>
									<tr>
										<td align="center"><input name="email" type="email" style="width:100%"
												placeholder="Email" required="required" id="add_member_email" /></td>
									</tr>
									<tr>
										<td align="center"><input name="salary" type="text" style="width:100%"
												placeholder="Salary" required="required" id="add_member_salary" /></td>
									</tr>
									<tr>
										<td align="center"><input name="username" type="text" style="width:100%"
												placeholder="Username" required="required" id="add_member_username" />
										</td>
									</tr>
									<tr>
										<td align="center"><input name="password" type="text" style="width:100%"
												placeholder="Password" required="required" id="add_member_password" />
										</td>
									</tr>
									<tr>
										<td align="right"><input type="submit" value="add" name="submit"
												class="add_member" /></td>
									</tr>
								</table>
							</form>
