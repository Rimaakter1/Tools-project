												...
												<div class="item_card">
													...
													<div class="prices">
														<span class="new_price">
															<span>
																<?php echo $row["new_price"] ?>TK
															</span>
														</span>

														<span class="old_price">
															<?php echo $row["item_price"] ?>TK
															<span></span>
														</span>
													...
													<div class="card-footer">
														...
														<span class="text-title">Start date: <span
																id="sd_<?php echo $row['offer_id']; ?>">
																<?php echo $row['start_date'] ?>
															</span></span>
														<span class="text-title">End date: <span
																id="ed_<?php echo $row['offer_id']; ?>">
																<?php echo $row['end_date'] ?>
															</span></span>
														<span class="warning_mess">
															<?php echo $message; ?>
														</span>
								...
								<table width="220" height="106" border="0">
									...
									<tr>
										<td align="center"><input name="pourcentage" type="text" style="width:100%"
												placeholder="pourcentage" required="required" /></td>
									</tr>
									<tr>
												...
												<div class="panel panel-default">
													<div class="panel-body">
														<form action="" method="post" enctype="multipart/form-data">
															...
															<div class="form-group">
																<label
																	class="col-sm-3 col-md-4 control-label">Pourcentage</label>
																<div class="col-sm-8">
															...
															<div class="form-group">
																<label class="col-sm-3 col-md-4 control-label">end
																	date</label>
																<div class="col-sm-8">
