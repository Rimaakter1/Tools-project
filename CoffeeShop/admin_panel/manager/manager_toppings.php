									...
									<div class="card">
                                       ...
                                       FROM toppings t1,toppingscategory t2 WHERE t1.topping_category_id=t2.topping_category_id";
                                        ...
                                        while ($row = mysqli_fetch_assoc($result)) { ?>
												...
												<div class="toppings_info topping_<?php echo $row['topping_id']; ?> <?php if ($row['topping_category_id'] == 1) {
		                                        echo 'show';
	                                        } ?>"
													...
													<div class="card-title">
														<span id="name_<?php echo $row['topping_id']; ?>">
															<?php echo $row['topping_name'] ?>
														</span>

														<span>price:<span class="topping-price"
																id="price_<?php echo $row['topping_id']; ?>">
																<?php echo $row['topping_price'] ?>TK
															</span></span>
													</div>
								...
								<table width="220" height="106" border="0">
									...
									<tr>
										<td align="center"><input name="name" type="text" style="width:100%"
												placeholder="Topping Name" required="required" id="add_topping_name" />
										</td>
									</tr>
									<tr>
										<td align="center"><input name="price" type="text" style="width:100%"
												placeholder="Price" required="required" id="add_topping_price" /></td>
									</tr>
												...
												<div class="panel panel-default">
													<div class="panel-body">
														<form action="" method="post" enctype="multipart/form-data">
															...
															<div class="form-group">
																<label class="col-sm-3 col-md-4 control-label">Topping
																	Name</label>
																<div class="col-sm-8">
