									...
									<div class="card">
                                       ...
                                       FROM menuitem m1,menu m2 WHERE m1.menu_id=m2.menu_id";
                                        ...
                                        while ($row = mysqli_fetch_assoc($result)) { ?>
												...
												<div class="item_card item_<?php echo $row['item_id']; ?> <?php if ($row['menu_id'] == 1) {
		                                        echo 'show';
	                                        } ?>"
													...
													<div class="card-footer">
														<span class="text-title">TK<span
																id="price_<?php echo $row['item_id']; ?>">
												...
												<div class="panel panel-default">
													<div class="panel-body">
														<form action="" method="post" enctype="multipart/form-data">
															...
															<div class="form-group">
																<label class="col-sm-3 col-md-4 control-label">Item
																	Name</label>
																<div class="col-sm-8">
