...
<header>
    <a href="#" class="logo"><i class="fas fa-utensils"></i>Steamy Beans</a>
    ...
    <div class="icons">
        ...
        if (isset($_SESSION["currency"])) {
            ...
            $currency_logo = $_SESSION["currency"]["logo"] = "TK";
        ...
        <select id="currency_list">
            ...
            <option value="<?php echo $row['to_currency'] ?>" selected>
                <?php echo $row['to_currency'] ?>
            </option>
            <?php } else { ?>
            <option value="<?php echo $row['to_currency'] ?>">
                <?php echo $row['to_currency'] ?>
            </option>
            <?php }
